...
import static com.http.mska.security.Constants.ISSUER_INFO;
...
import static com.http.mska.security.Constants.TOKEN_EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			UsuarioSecurity credenciales = new ObjectMapper().readValue(request.getInputStream(), UsuarioSecurity.class);
