...
import com.http.mska.dao.BandagesTecnicoDAO;
import com.http.mska.dto.BandagesTecnico;

@Service 

public class BandagesTecnicoServiceImpl implements BandagesTecnicoService{
	@Autowired
	BandagesTecnicoDAO bandagesTecnicoDAO;
