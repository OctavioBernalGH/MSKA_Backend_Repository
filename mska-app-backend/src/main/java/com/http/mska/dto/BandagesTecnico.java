...
@Entity
@Table(name = "BandagesTecnico")

public class BandagesTecnico {
	...
	public BandagesTecnico() {
		super();
	}

	public BandagesTecnico(Long id, String nombre, String desencadenante, String tipo, String descripcion,
			String cantidadExp) {
		super();
		this.id = id;
		this.nombre = nombre;
